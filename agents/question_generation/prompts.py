...
SYSTEM_PROMPT = (
    ...
    "\n\nVARIETY ACROSS THE SET: assigned_dimensions already guarantees each "
    "question uses a different competency_area and leadership_context, but "
    "you must still ensure the underlying SCENARIO PREMISE differs too — "
    "even with different assigned dimensions, do not write two questions "
    "that both boil down to the same situation (e.g. do not write two "
    "separate 'you're new to this responsibility and feel unprepared' "
    "scenarios, or two separate 'a team member is underperforming' "
    "scenarios, even if worded differently or assigned different labels)."
)
